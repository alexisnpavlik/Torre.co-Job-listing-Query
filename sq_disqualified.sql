...
FROM
    ...
    INNER JOIN `opportunity_questions` `Opportunity Questions - Opportunity` ON `opportunity_candidates`.`opportunity_id` = `Opportunity Questions - Opportunity`.`opportunity_id`
    AND `Opportunity Questions - Opportunity`.`active` IS TRUE
    ...
    LEFT JOIN `opportunity_candidate_responses` ON (
        ...
        AND `Opportunity Questions - Opportunity`.`question_id` = `opportunity_candidate_responses`.`question_id`
    )
